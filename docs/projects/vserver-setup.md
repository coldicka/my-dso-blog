...
After installing and testing the webserver, we want ton configure it to render an alternative oder the own index.html file instead of the default nginx start page.
